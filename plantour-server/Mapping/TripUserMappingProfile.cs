...
public class TripUserMappingProfile : Profile
{
    public TripUserMappingProfile()
    {
        ...
        .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.AdminParticipant.ParticipantId))
        ...
        CreateMap<CreateTripUserRequest, TripUser>()
            ...
            .ForMember(dest => dest.TripUserExpenseRecipients, opt => opt.Ignore())
            .ForMember(dest => dest.TripUserExpenseTripUsers, opt => opt.Ignore());
