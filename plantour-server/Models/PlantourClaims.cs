...
public static class PlantourClaims
{
    ...
    public const string PaymentProcessorSubscriptionId = "payment_processor_subscription_id";
    public const string PaymentProcessorCustomerId = "payment_processor_customer_id";
