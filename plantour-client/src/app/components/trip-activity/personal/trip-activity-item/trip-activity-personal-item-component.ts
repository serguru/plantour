...
@Component({
  selector: 'app-trip-activity-personal-item',
  imports: [FormsModule, Select, AmazonLinkComponent],
  templateUrl: './trip-activity-personal-item-component.html',
  styleUrl: './trip-activity-personal-item-component.scss',
})
export class TripActivityPersonalItemComponent {
