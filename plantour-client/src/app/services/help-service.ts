...
const COMPONENT_HELP_PAGE_IDS: Readonly<Record<string, string>> = {
  ...
  'sign-in': 'help/get-started/sign-in-or-sign-up',
  'signin-token': 'help/get-started/sign-in-or-sign-up',
  ...
  'trip-users': 'help/trip-workflows/work-with-trip-participants',
  'trip-user-form': 'help/trip-workflows/work-with-trip-participants',
...
const ROUTE_HELP_PAGE_MATCHERS: ReadonlyArray<{ pattern: RegExp; pageId: string }> = [
  ...
  { pattern: /^\/trips\/[^/]+\/trip-participants(?:\/.*)?$/, pageId: 'help/trip-workflows/work-with-trip-participants' },
